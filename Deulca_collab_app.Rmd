...
# BiocManager::repositories("https://git.bioconductor.org/packages/XVector")
# options(repos = BiocManager::repositories("git clone https://git.bioconductor.org/packages/XVector"))
...
library(plotly)
library(heatmaply)
>>>>>>> f8b28296b1a296c50b3c301a6e9cc12f3582613b
```
