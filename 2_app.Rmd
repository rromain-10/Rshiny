...
server<- function(input,output, session) {
  ...
  ({
    ...
    #   dds$sample
    #   #AKT1
    #   plotCounts(dds, gene=print(input$Gene2),intgroup = c("sample"),       cex.main=2,                cex=1.5, xlab= "Sample", returnData = T)
    #   pc_1<-plotCounts(dds, gene=print(input$Gene2),intgroup =          c("sample"),                   cex.main=2, cex=1.5, xlab= "Sample", returnData = T)
    #   ggplot (pc_1,aes(x=sample,y=count)) +
    #     geom_boxplot(aes(fill=sample, alpha=0.9))+ stat_summary( geom="point", shape=20, size=5,         color="red", fill="red") +
    #     geom_jitter()+scale_y_log10() + 
